...
Install the [Windows 2022 base box](https://github.com/inveks/windows-vagrant).

Install the [Ubuntu 20.04 base box](https://github.com/inveks/ubuntu-vagrant).
...
Follow the [inveks/windows-vagrant Hyper-V Usage section](https://github.com/inveks/windows-vagrant#hyper-v-usage).
